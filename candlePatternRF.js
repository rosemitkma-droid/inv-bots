...
const DEFAULT_ASSET_CONFIG = {
  ...
  EXTRA_LEVEL_MULTIPLIERS: [1.8, 2.0, 2.0, 2.1, 2.1, 2.2, 2.2],
...
const HISTORY_FILE = path.join(__dirname, 'candlePatternRF-multi-history00000001.json');
...
const STATE_FILE = path.join(__dirname, 'candlePatternRF-multi-state00000001.json');
