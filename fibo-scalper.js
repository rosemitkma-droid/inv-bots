...
const StateManager = {
    stateFile: path.join(__dirname, 'fibo-scalper1-state.json'),
    lastSaveTime: 0,
...
const StrategyEngine = {
    analyze(symbol) {
        ...
        if (asset.fibLevels && inGoldenZone && signal) {
