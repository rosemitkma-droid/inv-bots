...
class EnhancedDigitDifferTradingBot {
    ...
    async sendEmailSummary() {
        ...
        const mailOptions = {
            ...
            subject: '2Grok_Enhanced Accumulator Bot - Performance Summary',
            text: summaryText
        };
    ...
    async sendLossEmail(asset) {
        ...
        const mailOptions = {
            from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: `2Grok_Enhanced Accumulator Bot - Loss Alert [${asset}]`,
            text: summaryText
        };
    ...
    async sendErrorEmail(errorMessage) {
        ...
        const mailOptions = {
            from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: '2Grok_Enhanced Accumulator Bot - Error Report',
