...
class DerivClient extends EventEmitter{
  ...
  _openWs(url){
    try{
      this.ws=new WebSocket(url,{headers:{'User-Agent':'hazardBot_v3'},handshakeTimeout:15000});
...
async function main(){
  ...
  console.log('  HazardBot_v3 — post-spike less restrictive');
  console.log('═'.repeat(72));
