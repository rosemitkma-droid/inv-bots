...
const CONFIG = Object.freeze({
  ...
  minEdge: numEnv('MIN_EDGE', 0.0002),               //0.0045 min raw value edge (probability points)
  minStandardizedEdge: numEnv('MIN_STD_EDGE', 0.02), //0.50 min cross-asset z edge
  ...
  // Persistence/logging
  stateFile: strEnv('STATE_FILE', 'deriv_prism_differ7_state.json'),
  logFile: strEnv('LOG_FILE', 'deriv_prism_differ7_bot.log'),
