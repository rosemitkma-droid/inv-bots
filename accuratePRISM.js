...
const CONFIG = Object.freeze({
  ...
  minEdge: numEnv('MIN_EDGE', 0.0020),               //0.0045 min raw value edge (probability points)
  minStandardizedEdge: numEnv('MIN_STD_EDGE', 0.25), //0.50 min cross-asset z edge
  ...
  // Persistence/logging
  stateFile: strEnv('STATE_FILE', 'deriv_prism_differ5_state.json'),
  logFile: strEnv('LOG_FILE', 'deriv_prism_differ5_bot.log'),
