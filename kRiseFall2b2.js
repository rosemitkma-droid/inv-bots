...
// ============================================
const STATE_FILE = path.join(__dirname, 'KriseFallM_2b_0008-state.json');
const HISTORY_FILE = path.join(__dirname, 'KriseFallM_2b_0008-history.json');
const MAXSTREAK_FILE = path.join(__dirname, 'KriseFallM_2b_0008-maxstreak.json');
