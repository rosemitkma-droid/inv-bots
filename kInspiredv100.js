...
class EnhancedDigitDifferTradingBot {
    ...
    async sendEmailSummary() {
        ...
        const mailOptions = {
            ...
            subject: 'kInspired v100 Accumulator Bot - Performance Summary',
            text: summaryText
        };
    ...
    async sendLossEmail(asset) {
        ...
        const mailOptions = {
            from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: `kInspired v100 Accumulator Bot - Loss Alert [${asset}]`,
            text: summaryText
        };
    ...
    async sendErrorEmail(errorMessage) {
        ...
        const mailOptions = {
            from: this.emailConfig.auth.user,
            to: this.emailRecipient,
            subject: 'kInspired v100 Accumulator Bot - Error Report',
    ...
    start() {
        console.log('🚀 Starting kInspired v100 Accumulator Trading Bot with Learning System');
