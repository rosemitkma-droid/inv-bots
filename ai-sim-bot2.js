...
class AILogicDigitDifferBot {
    ...
    async analyzeTicks() {
        ...
        if (FDA_Engine && !MCP_Engine && !EITE_Engine && !PRNN_Engine && !BPE_Engine && !GAMR_Engine && !MTD_Engine && !CTAF_Engine && !MCS_Engine) {
        ...
        if (MCP_Engine && !FDA_Engine && !EITE_Engine && !PRNN_Engine && !BPE_Engine && !GAMR_Engine && !MTD_Engine && !CTAF_Engine && !MCS_Engine) {
        ...
        // if (EITE_Engine && !FDA_Engine && !MCP_Engine && !PRNN_Engine && !BPE_Engine && !GAMR_Engine && !MTD_Engine && !CTAF_Engine && !MCS_Engine) {
        ...
        // } else
        if (PRNN_Engine && !FDA_Engine && !MCP_Engine && !EITE_Engine && !BPE_Engine && !GAMR_Engine && !MTD_Engine && !CTAF_Engine && !MCS_Engine) {
        ...
        if (BPE_Engine && !FDA_Engine && !MCP_Engine && !EITE_Engine && !PRNN_Engine && !GAMR_Engine && !MTD_Engine && !CTAF_Engine && !MCS_Engine) {
        ...
        if (GAMR_Engine && !FDA_Engine && !MCP_Engine && !EITE_Engine && !PRNN_Engine && !BPE_Engine && !MTD_Engine && !CTAF_Engine && !MCS_Engine) {
        ...
        if (MTD_Engine && !FDA_Engine && !MCP_Engine && !EITE_Engine && !PRNN_Engine && !BPE_Engine && !GAMR_Engine && !CTAF_Engine && !MCS_Engine) {
        ...
        if (CTAF_Engine && !FDA_Engine && !MCP_Engine && !EITE_Engine && !PRNN_Engine && !BPE_Engine && !GAMR_Engine && !MTD_Engine && !MCS_Engine) {
        ...
        if (MCS_Engine && !FDA_Engine && !MCP_Engine && !EITE_Engine && !PRNN_Engine && !BPE_Engine && !GAMR_Engine && !MTD_Engine && !CTAF_Engine) {
...
const bot = new AILogicDigitDifferBot({
    derivToken: 'rgNedekYXvCaPeP', //process.env.DERIV_TOKEN,
