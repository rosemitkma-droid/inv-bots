...
class AIWeightedEnsembleBot {
    ...
    placeTrade(asset, predictedDigit, bestAvgZ, concentration, participation) {
        ...
        console.log(`Placing Trade: [${asset}] Digit ${predictedDigit}(${bestAvgZ.toFixed(2)}) | Conc=${concentration.toFixed(4)} | Stake: $${this.currentStake.toFixed(2)}`);
    ...
    handleTradeResult(contract) {
        ...
        const telegramMsg = `
            ${resultEmoji} (Romanian Ghost Differ Bot)
    ...
    start() {
        console.log('🚀 Starting Romanian Ghost Differ Bot...');
