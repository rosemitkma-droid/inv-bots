...
const CONFIG = Object.freeze({
  ...
  // Persistence/logging
  stateFile: strEnv('STATE_FILE', 'accurateDifferKelly_01_state.json'),
  logFile: strEnv('LOG_FILE', 'accurateDifferKelly_01_bot.log'),
  ...
  backtestOutFile     : strEnv('BACKTEST_OUT',        'accurateDifferKelly_backtest_01_report.json'),
